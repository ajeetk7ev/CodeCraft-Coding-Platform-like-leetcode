...
export const getSubmissionsPerDay = catchAsync(
  async (req: Request, res: Response) => {
...
// Get AC vs WA ratio
export const getAcVsWaRatio = catchAsync(
  async (req: Request, res: Response) => {
...
export const getMostSolvedProblems = catchAsync(
  async (req: Request, res: Response) => {
...
export const getDifficultyDistribution = catchAsync(
  async (req: Request, res: Response) => {
...
// Assign role to user
export const assignUserRole = catchAsync(
  async (req: Request, res: Response) => {
    const { userId } = req.params;
    const { role } = req.body;
...
export const toggleProblemPublish = catchAsync(
  async (req: Request, res: Response) => {
